<%-- 
    Document   : contact
    Created on : Oct 25, 2024, 4:32:49 PM
    Author     : Admin
--%>
...
<html lang="en">
    <%
        ...
        if(request.getAttribute("listCart") == null){
            listCart = new CartDAO().getCartList(ua.getUserID());
        } else {
            listCart = (List) request.getAttribute("listCart");
        }
        int sumPrice = 0;
    ...
    <body>
        ...
        <%if(listCart.isEmpty()){%>
        <div class="container">
            <h1 class="title-head" style="font-size: 30px; margin-bottom: 40px;">Giỏ hàng của bạn đang trống!</h1>
        </div> 
        <%} else {%>
                                ...
                                <div class="ajaxcart__inner ajaxcart__inner--has-fixed-footer cart_body items">
                                    ...
                                    <div class="ajaxcart__row">
                                        <div class="ajaxcart__product cart_product">
                                            <a href="./productDetail?productID=<%=c.getProductID().getProductID()%>" class="ajaxcart__product-image cart_image" title="Chân váy nữ"><img
                                                    src="<%=c.getProductID().getImages()%>"
                                                    alt=""></a>
                                            <div class="grid__item cart_info">
                                                <div class="ajaxcart__product-name-wrapper cart_name">
                                                    <a href="./productDetail?productID=<%=c.getProductID().getProductID()%>" class="ajaxcart__product-name h4"><%=c.getProductID().getProductName()%></a>
                                                    <!--                                                        <a class="cart__btn-remove remove-item-cart ajaxifyCart--remove" href="javascript:;"
                                                                                                               >Đặt hàng</a>-->
                                                    <a class="cart__btn-remove remove-item-cart ajaxifyCart--remove" href="./deleteCart?cartID=<%=c.getCartID()%>"
                                                       >Xóa</a>

                                                </div>
                                                <div class="grid">
                                                    <div class="grid__item one-half text-right cart_prices">
                                                        <span class="cart-price"><%=formatter.format(c.getProductID().getUnitPrice() * (100 - c.getProductID().getDiscount()) / 100)%>₫</span>
                                                ...
                                                <div class="grid">
                                                    <div class="grid__item one-half cart_select">
                                                        <div class="ajaxcart__qty input-group-btn">
                                                            <p class="quatity"><%=c.getQuantity()%></p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="grid">
                                                    <div class="grid__item one-half text-right cart_prices">
                                                        <span class="cart-price"><%=formatter.format((c.getProductID().getUnitPrice() * (100 - c.getProductID().getDiscount()) / 100) * c.getQuantity())%>₫</span>
                                    ...
                                    <%
                                            sumPrice += (c.getProductID().getUnitPrice() * (100 - c.getProductID().getDiscount()) / 100) * c.getQuantity();
                                        }
                                    %>
                                ...
                                <div class="ajaxcart__footer ajaxcart__footer--fixed cart-footer">
                                    <div class="row">
                                        <div class="col-lg-4 col-12 offset-md-8 offset-lg-8 offset-xl-8">
                                            <label style="margin-top: 10px; color: red;    font-size: 18px;
                                                   margin-bottom: 7px;">Quý khách kiểm tra kỹ trước khi đặt hàng!</label>
                                            <div class="ajaxcart__subtotal">
                                                <div class="cart__subtotal">
                                                    <div class="cart__col-6">Tổng tiền:</div>
                                                    <div class="text-right cart__totle"><span class="total-price"><%=formatter.format(sumPrice)%>₫</span></div>
                                                </div>
                                            </div>
                                            <div class="cart__btn-proceed-checkout-dt">
                                                <form action="orderViaCart" method="post">
                                                    <button type="submit" class="button btn btn-default cart__btn-proceed-checkout" id="btn-proceed-checkout">
                                                        Đặt hàng
                                                    </button>
                                                </form>
                                            </div>
