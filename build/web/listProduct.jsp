...
<html lang="en">
    ...
    <body>
        ...
        <section class="bread-crumb">
            <div class="container">
                <ul class="breadcrumb">
                    ...
                    <%if(id == 0){%>
                    <li><strong><span>Tất cả sản phẩm (<%=listProduct.size()%> mặt hàng)</span></strong></li>
                                <%} else {%>
                    <li><strong><span><%=c.getCategoryName()%> (<%=listProduct.size()%> mặt hàng)</span></strong></li>
                                <%}%>
                </ul>
            </div>
        </section>
        ...
        <div class="container">
            <p style="color: green; font-size: 18px;"><span>${requestScope.success}</span></p>
        </div>
