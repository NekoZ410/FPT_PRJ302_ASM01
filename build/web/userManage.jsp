<%-- 
    Document   : userManage
    Created on : Oct 31, 2024, 8:07:15 PM
    Author     : ASUS
--%>
...
<html lang="en">
    <%
        ...
        if(request.getAttribute("listUserAccount") ==  null){
            listUserAccount = new UserAccountDAO().getUserAccountList();
        } else {
            listUserAccount = (List) request.getAttribute("listUserAccount");
        }
    ...
    <body>
        ...
        <section class="bread-crumb">
            <div class="container">
                <ul class="breadcrumb">
                    ...
                    <li><strong><span>Quản lý người dùng</span></strong></li>
                </ul>
            </div>
        </section>
        ...
        <div class="container">
            <form action="searchUser" method="post">
                <p class="timkiemnhanvien"><b>TÌM KIẾM TÀI KHOẢN:</b></p>

                <div class="user-search">

                    <input type="text" name="name" required placeholder="Nhập tên tài khoản cần tìm..." />
                    <button type="submit"><span><i class="fa fa-search" aria-hidden="true"></i></span></button>

                </div>
            </form>
            <b>THÔNG TIN NGƯỜI DÙNG</b><br />
            <form action="sortUser" method="post">
                <button class="nv" type="submit" title="Lọc Dữ Liệu">
            ...
            <table class="table table-bordered" id="myTable">
                <thead>
                    <tr class="ex">
                        ...
                        <th width="auto">Gmail</th>
                        <th>Xóa tài khoản</th>                        
                    </tr>
                </thead>
                <%for(UserAccount ua : listUserAccount){%>
                <tbody>
                    <tr>
                        <td><%=ua.getUserName()%></td>
                        <td><%=ua.getAccountName()%></td>
                        <td><%=sdf.format(ua.getCreatedDate())%></td>
                        <td><%=ua.getEmail()%></td>
                        <td>                            
                            <a class="delete" title="Xóa" href="./deleteAccount?userID=<%=ua.getUserID()%>"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                        </td>
                    </tr>
                </tbody>
                <%}%>
