                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-lg-3 col-left-ac">
                        <div class="block-account">
                            ...
                            <p>Xin chào, <span style="color:#ef4339;">${sessionScope.userAccount.userName}</span>&nbsp;!</p>
                            <ul>
                                <li>
                                    <a class="title-info" href="accountInfo.jsp">Thông tin tài khoản</a>
                                </li>
                                <li>
                                    <a disabled="disabled" class="title-info active">Đổi mật khẩu</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-lg-5 col-right-ac">
                        <h1 class="title-head margin-top-0">Đổi mật khẩu</h1>
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <div class="page-login">
                                    <form method="post" action="changePassword" id="change_customer_password"
                                          accept-charset="UTF-8"><input name="FormType" type="hidden" value="change_customer_password"><input
                                        ...
                                        <div class="form-signup clearfix">
                                            ...
                                            <button class="button btn-edit-addr btn btn-primary btn-more" type="submit"
                                                    onclick="window.location.reload()"><i class="hoverButton"></i>Đặt lại mật khẩu</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-lg-4 col-center-ac">
                        <div id="logo">
                            <img src="images/slide-logo/logo.jpg" alt="logo"/>
                        </div>
                    </div>
                </div>
            </div>
