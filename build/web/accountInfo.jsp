                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-lg-3 col-left-ac">
                        <div class="block-account">
                            ...
                            <ul>
                                <li>
                                    <a disabled="disabled" class="title-info active">Thông tin tài khoản</a>
                                </li>
                                <li>
                                    <a class="title-info" href="changePassword.jsp">Đổi mật khẩu</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-lg-5 col-center-ac">
                        <h1 class="title-head margin-top-0">Thông tin tài khoản</h1>
                        <div class="form-signup name-account m992">
                            <p><strong>Họ tên:</strong> ${sessionScope.userAccount.userName}</p>
                            <p><strong>Tên tài khoản:</strong>  ${sessionScope.userAccount.accountName}</p>
                            <p> <strong>Email:</strong> ${sessionScope.userAccount.email}</p>
