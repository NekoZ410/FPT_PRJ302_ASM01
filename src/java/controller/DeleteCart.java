...
//        processRequest(request, response);
        ...
        String xCartID= request.getParameter("cartID");
        int cartID= Integer.parseInt(xCartID);
       
      
        CartDAO cd= new CartDAO();
        cd.deleteCart(ua.getUserID(), cartID);
        
        List<Cart> listCart = cd.getCartList(ua.getUserID());
