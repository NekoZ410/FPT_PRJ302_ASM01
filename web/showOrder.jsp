...
<html lang="en">
    <%
       ...
       UserAccount ua = (UserAccount) session.getAttribute("userAccount");
        ...
        if(request.getAttribute("listOrder") == null){
            listOrder = new OrderDAO().getOrderList(ua.getUserID());
        } else {
            listOrder = (List) request.getAttribute("listOrder");
        }
        int sumPrice = 0;
    ...
    <body>
        ...
        <div class="container">
            <h1 class="title-head" style="font-size: 30px; margin-bottom: 40px;">Không tìm thấy đơn hàng của bạn!</h1>
        </div>
        <%} else {%>
                                ...
                                <div class="ajaxcart__inner ajaxcart__inner--has-fixed-footer cart_body items">
                                    ...
                                    <div class="ajaxcart__row">
                                        <div class="ajaxcart__product cart_product">
                                            <a href="./productDetail?productID=<%=o.getProductID().getProductID()%>" class="ajaxcart__product-image cart_image"><img
                                                    src="<%=o.getProductID().getImages()%>"
                                                    alt=""></a>
                                            <div class="grid__item cart_info">
                                                <div class="ajaxcart__product-name-wrapper cart_name">
                                                    <a href="./productDetail?productID=<%=o.getProductID().getProductID()%>" class="ajaxcart__product-name h4"><%=o.getProductID().getProductName()%></a>
                                                </div>
                                                <div class="grid">
                                                    <div class="grid__item one-half text-right cart_prices">
                                                        <span class="cart-price"></span>
                                                        <span class="cart-price-compare"><%=sdf.format(o.getOrderDate())%></span>
                                                    </div>
                                                </div>
                                                <div class="grid">
                                                    <div class="grid__item one-half text-right cart_prices">
                                                        <span class="cart-price"></span>
                                                        <span class="cart-price-compare"><%=sdf.format(o.getRequiredDate())%></span>
                                                    </div>
                                                </div>
                                                <div class="grid">
                                                    <div class="grid__item one-half text-right cart_prices">
                                                        <span class="cart-price"><%=formatter.format(o.getProductID().getUnitPrice() * (100 - o.getProductID().getDiscount()) / 100)%>₫</span>
                                                ...
                                                <div class="grid">
                                                    <div class="grid__item one-half cart_select">
                                                        <div class="ajaxcart__qty input-group-btn">
                                                            <p class="quatity"><%=o.getQuantity()%></p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="grid">
                                                    <div class="grid__item one-half text-right cart_prices">
                                                        <span class="cart-price"><%=formatter.format(o.getFreight())%>₫</span>

                                                    </div>
                                                </div>
                                                <div class="grid">
                                                    <div class="grid__item one-half text-right cart_prices">
                                                        <span class="cart-price"><%=formatter.format((o.getProductID().getUnitPrice() * (100 - o.getProductID().getDiscount()) / 100) * o.getQuantity() + o.getFreight())%>₫</span>
                                    ...
                                    <%
                                            sumPrice += (o.getProductID().getUnitPrice() * (100 - o.getProductID().getDiscount()) / 100) * o.getQuantity() + o.getFreight();
                                        }
                                    %>
                                        ...
                                        <div class="col-lg-4 col-12 offset-md-8 offset-lg-8 offset-xl-8">
                                            ...
                                            <div class="cart__btn-proceed-checkout-dt">
                                                <form action="checkOut" method="post">
                                                    ...
                                                    <button type="submit" class="button btn btn-default cart__btn-proceed-checkout" id="btn-proceed-checkout" onclick="">
                                                        Thanh toán
                                                    </button>
                                                </form>
                                            </div>
