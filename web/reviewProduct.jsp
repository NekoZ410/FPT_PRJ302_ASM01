...
<html>
   ...
   Product p = (Product) request.getAttribute("productID"); 
        ...
        <section class="bread-crumb">
            <div class="container">
                <ul class="breadcrumb">
                    ...
                    <li><strong><span>Đánh giá sản phẩm</span></strong></li>
                    ...
                    <div class="row">
                        ...
                        <div class="details-pro col-12 col-md-12 col-lg-5">
                            ...
                            <form action="reviewProduct" method="post">
                                ...
                                <textarea id="id" name="comment" rows="10" cols="10"></textarea>
                                ...
                                <div class="btn-mua">
                                    ...
                                    <button type="submit" class="btn btn_base normal_button add_to_cart">
                                        <span class="txt-main text_1">Đánh giá sản phẩm</span>
                                    </button>
                                </div>
                            </form>
                        </div>
