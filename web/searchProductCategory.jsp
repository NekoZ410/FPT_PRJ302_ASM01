...
<%
    ...
    List<Product> listProduct = (List) request.getAttribute("searchProduct");
        ...
        <section class="signup search-main wrap_background background_white clearfix">
            <div class="container">
                ...
                <div class="margin-bottom-15 no-padding">
                    <h1 class="title-head title_search">Có <%=listProduct.size()%> kết quả tìm kiếm phù hợp</h1>
                </div>
                <% } %>
                                ...
                                <div class="item_product_main">
                                    ...
                                    <div class="variants product-action">
                                        <div class="product-thumbnail">
                                            <a class="image_thumb scale_hover" href="./productDetail?productID=<%=listProduct.get(i).getProductID()%>" style="height: 255px;">
                                        ...
                                        <div class="product-info">
                                            <h3 class="product-name"><a href="/ao-len-nu"><%=listProduct.get(i).getProductName()%></a></h3>
                                            <div class="price-box">
