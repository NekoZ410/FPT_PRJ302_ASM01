...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="css/showPurchased.css" />
            ...
            <div class="container">
                <ul class="breadcrumb">
                    <li class="home">
                        ...
                        <a href="listPayment.jsp"><span>Hóa đơn thanh toán</span></a>
                        <span class="mr_lr">&nbsp;<svg aria-hidden="true" focusable="false" data-prefix="fas"
                                                       data-icon="chevron-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"
                                                       class="svg-inline--fa fa-chevron-right fa-w-10">
                            <path fill="currentColor"
                    ...
                    <li><strong><span>Chi tiết hóa đơn</span></strong></li>
                                ...
                                <div class="ajaxcart__inner ajaxcart__inner--has-fixed-footer cart_body items">
                                    ...
                                    <div class="ajaxcart__row">
                                        <div class="ajaxcart__product cart_product">
                                            <a href="./productDetail?productID=<%=p.getProductID().getProductID()%>" class="ajaxcart__product-image cart_image" title="Chân váy nữ"><img
                                                    src="<%=p.getProductID().getImages()%>"
                                                    alt=""></a>
                                            <div class="grid__item cart_info">
                                                <div class="ajaxcart__product-name-wrapper cart_name">
                                                    <a href="./productDetail?productID=<%=p.getProductID().getProductID()%>" class="ajaxcart__product-name h4"><%=p.getProductID().getProductName()%></a>
                                                    <%
                                                        Review r = rd.getReviewByUserAndProduct(ua.getUserID(), p.getProductID().getProductID());
                                                        if(r == null){
                                                    %>
                                                    <a class="cart__btn-remove remove-item-cart ajaxifyCart--remove" href="./showReview?productID=<%=p.getProductID().getProductID()%>"
                                                       >Đánh giá sản phẩm</a>
                                                    <%} else {%>
                                                ...
                                                <div class="grid">
                                                    <div class="grid__item one-half text-right cart_prices">
                                                        <span class="cart-price"><%=formatter.format(p.getProductID().getUnitPrice() * (100 - p.getProductID().getDiscount()) / 100)%>₫</span>
                                                ...
                                                <div class="grid">
                                                    <div class="grid__item one-half cart_select">
                                                        <div class="ajaxcart__qty input-group-btn">
                                                            <p class="quatity"><%=p.getQuantity()%></p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="grid">
                                                    <div class="grid__item one-half text-right cart_prices">
                                                        <span class="cart-price"><%=formatter.format((p.getProductID().getUnitPrice() * (100 - p.getProductID().getDiscount()) / 100) * p.getQuantity())%>₫</span>
                                    ...
                                    <%
                                            sumPrice += (p.getProductID().getUnitPrice() * (100 - p.getProductID().getDiscount()) / 100) * p.getQuantity() + p.getFreight();
                                        }
                                    %>
