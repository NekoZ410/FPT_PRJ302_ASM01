        ...
        <section class="bread-crumb">
            <div class="container">
                <ul class="breadcrumb">
                    ...
                    <%if(discount < 0) {%>
                    <li><strong><span>Các sản phẩm đang giảm giá (<%=listProduct.size()%> mặt hàng)</span></strong></li>
                                <%} else {%>
                    <li><strong><span>Sản phẩm đang giảm giá <%=discount%>% (<%=listProduct.size()%> mặt hàng)</span></strong></li>
                                <%}%>
                </ul>
            </div>
        </section>
                                ...
                                <div class="item_product_main">
                                    ...
                                    <div class="variants product-action">
                                        <div class="product-thumbnail">
                                            ...
                                            <div class="action"><form action="productDetail" method="get">
