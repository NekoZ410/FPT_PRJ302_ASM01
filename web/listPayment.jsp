...
<html lang="en">
    <%
        ...
        List<Payment> listPayment = new PaymentDAO().getPaymentByUserID(ua.getUserID());        
    ...
    <head>
        ...
        <link rel="stylesheet" href="css/listPayment.css" />
    ...
    <body>
        ...
        <section class="bread-crumb">
            <div class="container">
                <ul class="breadcrumb">
                    ...
                    <li><strong><span>Hóa đơn</span></strong></li>
        ...
        <div class="container">
            <h1 class="title-head" style="font-size: 30px; margin-bottom: 40px;">Không có hóa đơn nào!</h1>
        </div>
                                        ...
                                        <div class="ajaxcart__product cart_product">
                                            <div class="grid__item cart_info">
                                                <div class="ajaxcart__product-name-wrapper cart_name">
                                                    <p class="ajaxcart__product-name h4">Mã hóa đơn: PAYMENT#<%=p.getPaymentID()%></p>
                                                    <a class="cart__btn-remove remove-item-cart ajaxifyCart--remove" href="./paymentDetail?purchasedID=<%=p.getPaymentID()%>"
                                                       >Xem chi tiết</a>
                                                </div>
                                                <div class="grid">  
                                                    <div class="grid__item one-half text-right cart_prices">
                                                        <span class="cart-price"></span>
                                                        <span class="cart-price-compare"><%=sdf.format(p.getPaymentDate())%></span>
                                                    </div>
                                                </div>
                                                <div class="grid">
                                                    <div class="grid__item one-half cart_select">
                                                        <div class="ajaxcart__qty input-group-btn">
                                                            <p class="quatity"><%=p.getPaymentMethod()%></p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="grid">
                                                    <div class="grid__item one-half text-right cart_prices">
                                                        <span class="cart-price"><%=formatter.format(p.getPrice())%>₫</span>
