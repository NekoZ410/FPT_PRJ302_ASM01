<%-- 
    ...
    Created on : Oct 27, 2024, 4:22:50 PM
    Author     : ASUS
--%>
...
<html>
    ...
    List<Product> listProduct = pd.getProductListByCategoryID(p.getCategoryID().getCategoryID());
    NumberFormat formatter = NumberFormat.getInstance(new Locale("vi", "VN"));
    ReviewDAO rd = new ReviewDAO();
    List<Review> listReview = rd.listTopComment(p.getProductID());
    SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
    float avgRating = rd.avgRating(p.getProductID());
    %>
    <head>
        <script src="//bizweb.dktcdn.net/100/455/315/themes/894917/assets/jquery.js?1724746453440"
        ...
        <link rel="preload" as='style' type="text/css"
              href="//bizweb.dktcdn.net/100/455/315/themes/894917/assets/index.scss.css?1724746453440">
            ...
            <div class="container">
                <ul class="breadcrumb">
                    <li class="home">
                        ...
                        <a href="./listProduct?categoryID=<%=p.getCategoryID().getCategoryID()%>"><span><%=p.getCategoryID().getCategoryName()%></span></a>
                        <span class="mr_lr">&nbsp;<svg aria-hidden="true" focusable="false" data-prefix="fas"
                                                       data-icon="chevron-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"
                                                       class="svg-inline--fa fa-chevron-right fa-w-10">
                            <path fill="currentColor"
                    ...
                    <li><strong><span><%=p.getProductName()%></span></strong></li>
            ...
            <div class="container">
                <div class="details-product">
                    <div class="row">
                                        ...
                                        <a class="swiper-slide" data-hash="0"
                                           ...
                                           title="Click để xem">
                                            <img height="540" width="540"
                                                 src="<%=p.getImages()%>"
                                                 alt="&#193;o len nữ"
                                                 data-image="https://bizweb.dktcdn.net/100/455/315/products/3-jpeg-dcba3f1d-413f-4e83-87bb-c21479ea321b.jpg?v=1653358923853"
                        ...
                        <div class="details-pro col-12 col-md-12 col-lg-5">
                            <h1 class="title-product"><%=p.getProductName()%></h1>
                            ...
                            <div class="sku variant-sku" style="font-size: 18px">
                                Tình trạng:
                            ...
                            <c:if test="${sessionScope.userAccount.role == 'Admin'}">
                                <div class="sku variant-sku" style="font-size: 18px">Số lượng trong kho: <%=p.getUnitInStock()%></div>
                            </c:if>
                            <div 
                                class="form-inline">
                                <div class="price-box clearfix">
                                    ...
                                    <span class="special-price">
                                        <span class="price product-price"><%=formatter.format(p.getUnitPrice() * (100 - p.getDiscount()) / 100)%>₫</span>
                                    </span>
                                    <%if(p.getDiscount() > 0) {%>
                                    <span class="old-price">
                                        <del class="price product-price-old">
                                            <%=formatter.format(p.getUnitPrice())%>₫
                                        </del>
                                    </span>
                                    <%} %>
                                    ...
                                    <div class="avg-rating">
                                        <div class="rating-product">
                                            <progress class="rating-bg" value="<%=avgRating%>" max="5"></progress>
                                            <svg>
                                            <use xlink:href="#fivestars" />
                                            </svg>

                                        </div>
                                            <div style="font-size: 24px">(<%=avgRating%>)</div>
                                    </div>
                                    <%}%>
                                </div>
                                ...
                                <div class="form-product">
                                    ...
                                    <div class="box-variant clearfix  d-none ">
                                        ...
                                        <input type="hidden" id="one_variant" name="variantId" value="65721053" />

                                    </div>
                                    <div class="service_product">
                                        <div class="service">
                                            <a><img class="img-responsive"
                                                    src="//bizweb.dktcdn.net/100/455/315/themes/894917/assets/iamge_product2.png?1724746453440" /></a>
                                            <div class="title_text">
                                                <p class="title">Miễn phí vận chuyển </p>
                                                <p class="text">Cho đơn hàng từ 1.000.000đ</p>
                                            </div>
                                        </div>
                                        <div class="service">
                                            <a><img class="img-responsive"
                                                    src="//bizweb.dktcdn.net/100/455/315/themes/894917/assets/iamge_product1.png?1724746453440" /></a>
                                            <div class="title_text">
                                    ...
                                    <c:choose>                                       
                                        <c:when test="${sessionScope.userAccount.role == 'Admin'}">
                                            <div class="price-discount">
                                                <div class="sku variant-sku unit-price">
                                                    Giá gốc:

                                                    <input aria-label="Số lượng" type="text" class="qty input-text" id="price"
                                                           size="4" value="<%=p.getUnitPrice()%>" 
                                                           onkeypress="if (isNaN(this.value + String.fromCharCode(event.keyCode)))
                                                                       return false;"
                                                           onchange="if (this.value == 0)
                                                                       this.value = <%=p.getUnitPrice()%>;" />₫
                                                </div>
                                                <div class="sku variant-sku discount">
                                                    Giảm giá:
                                                ...
                                                <div class="flex-quantity">
                                                    <div class="qty-ant clearfix custom-btn-number">
                                                        ...
                                                        <div style="display: flex">
                                                            ...
                                                            <label style="margin-top: 10px; color: green;">${requestScope.success}</label>
                                                        </div>
                                                    </div>

                                                    <div class="btn-mua">
                                                        <form action="updateProduct" method="post">
                                                            <input name="productID" value="<%=p.getProductID()%>" type="hidden">
                                                            <input name="unitPrice" id="unitPrice" value="" type="hidden">
                                                            <input name="unitInStock" value="" id="quantity" type="hidden">
                                                            <input name="discount" id="discount" value=""  type="hidden">

                                                            <button type="submit" class="btn btn_base normal_button add_to_cart" onclick="
                                                                    var sourceValue = document.getElementById('qty').value;
                                                                    var sourcePrice = document.getElementById('price').value;
                                                                    document.getElementById('quantity').value = sourceValue;
                                                                    document.getElementById('unitPrice').value = sourcePrice;
                                                                    var discountSelect = document.getElementById('discountValue').value;
                                                                    document.getElementById('discount').value = discountSelect;
                                                                    ">
                                                                <span class="txt-main text_1">Cập nhật sản phẩm</span>
                                                            </button>
                                                        </form>                                                        
                                                    </div>
                                                    ...
                                                    <div class="btn-mua button_actions clearfix">
                                                        <form action="deleteProduct" method="post">
                                                            <input name="productID" value="<%=p.getProductID()%>" type="hidden">
                                                            <button type="submit" class="btn btn_base normal_button add_to_cart">
                                                                <span class="txt-main text_1">Xóa sản phẩm</span>
                                                            </button>
                                                        </form>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="flex-quantity">
                                                        ...
                                                        <div style="display: flex">
                                                            <div class="custom custom-btn-numbers clearfix input_number_product">
                                                                ...
                                                                <button
                                                                    onclick="var result = document.getElementById('qty');
                                                                            var qty = result.value;
                                                                            if (!isNaN(qty) && qty >= <%=p.getUnitInStock()%>) {
                                                                                result.value = <%=p.getUnitInStock()%>;
                                                                            } else {
                                                                                result.value++;
                                                                            }"
                                                                    class="btn-plus btn-cts" type="button">+</button>
                                                            </div>
                                                            <label style="margin-top: 10px; color: red;">${requestScope.error}</label>
                                                        </div>
                                                    </div>
                                                    <div class="btn-mua">
                                                        <form action="orderDirectly" method="post">
                                                            <input name="productID" value="<%=p.getProductID()%>" type="hidden">
                                                            <input name="quantity" id="quantity1" value="" type="hidden">

                                                            <button type="submit" class="btn btn_base normal_button add_to_cart" onclick="
                                                                    var sourceValue = document.getElementById('qty').value;
                                                                    document.getElementById('quantity1').value = sourceValue;
                                                                    ">
                                                    ...
                                                    <div class="btn-mua button_actions clearfix">
                                                        <form action="addCart" method="post">
                                                            <input name="productID" value="<%=p.getProductID()%>" type="hidden">
                                                            <input name="quantity" id="quantity2" value=""  type="hidden">

                                                            <button type="submit" class="btn btn_base normal_button add_to_cart" onclick="
                                                                    var sourceValue = document.getElementById('qty').value;
                                                                    document.getElementById('quantity2').value = sourceValue;
                                                                    ">
                            ...
                            <div class="tab-product">
                                ...
                                <div class="item-tab">
                                    <h3>
                                        ...
                                        <svg class="minus" xmlns="http://www.w3.org/2000/svg" width="20" height="2" viewBox="0 0 20 2"
                                             fill="none">
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M20 0V2H0V0H20Z" fill="black" />
                                        </svg>
                                        <svg class="plus" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18"
                                             fill="none">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                              d="M9.83317 8.16666H17.3332V9.83332H9.83317V17.3333H8.1665V9.83332H0.666504V8.16666H8.1665V0.666656H9.83317V8.16666Z"
                                              fill="#9E9E9E" />
                                        </svg>
                                    </h3>
                                    <div class="rte product_getcontent">
                                        ...
                                        <div id="content">
                                            <p><%=p.getCategoryID().getDescription()%></p>
                                        </div>
                                            ...
                                            <div class="rating">
                                                <div class="user-star">
                                                    <div class="user">
                                                        ...
                                                        <span><%=r.getUserID().getUserName()%></span>
                                                    ...
                                                    <div class="star-rating">
                                                        ...
                                                        <%} else {%>
                                                        <span class="star-rating checked">&#9733;</span>
                                                        <%
                                                            }
                                                        }
                                                        %>
                                                ...
                                                <em><span><%=sdf.format(r.getReviewDate())%></span></em>
                ...
                <div class="productRelate">
                    <div class="block-title">
                        <h2>
                            <a href="/quan-ao" title="Sản phẩm cùng loại">Sản phẩm cùng loại</a>
                        </h2>
                    </div>
                    <div class="relate-image">
                        ...
                        <div class="product-relate-swiper swiper-container">
                            <div class="swiper-wrapper">
                                ...
                                <%if(prd.getProductID() != p.getProductID()){%>
                                <div class="swiper-slide">
                                    <div class=" item_product_main">

                                        <div class="variants product-action">
                                            <div class="product-thumbnail">
                                                <a class="image_thumb scale_hover" href="./productDetail?productID=<%=prd.getProductID()%>">
                                                    <img class="lazyload"
                                                         src="<%=prd.getImages()%>"
                                                ...
                                                <div class="action">
                                                    <form action="productDetail" method="get">
                                                        ...
                                                        <button class="btn-cart btn-views" <c:if test="${sessionScope.userAccount.role == 'Admin'}">style="display:none"</c:if>>
                                                ...
                                                <div class="product-info">
                                                    <h3 class="product-name"><a href="./productDetail?productID=<%=prd.getProductName()%>"><%=prd.getProductName()%></a></h3>
                                                <div class="price-box">
                                                    <%=formatter.format(prd.getUnitPrice() * (100 - prd.getDiscount()) / 100)%>₫&nbsp;
                                                    <% if(prd.getDiscount() != 0){%>
                                                    <span class="compare-price"><%=formatter.format(prd.getUnitPrice())%>₫</span>
                                                    <%}%>
                                                </div>
                                            </div>
                                        </div>
