<%-- 
    Document   : searchProductCategory
    Created on : Oct 25, 2024, 5:23:56 PM
    Author     : Admin
--%>
...
<%
    ...
    if(request.getAttribute("listProduct") == null) {
        ...
        listProduct = (List) request.getAttribute("listProduct");
    }
...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="css/searchPrice.css" />
    ...
    <body>
        ...
        <section class="bread-crumb">
            <div class="container">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><strong><span>Tìm kiếm sản phẩm theo giá</span></strong></li>
                </ul>
            </div>
        </section>
        ...
        <div class="container">
            <p style="color: red; font-size: 18px;"><span>${requestScope.err}</span></p>
                    <%if(listProduct.isEmpty()){%>
            <h1 class="title-head" style="font-size: 30px; margin-bottom: 40px;">Không có kết quả phù hợp cho từ khóa!</h1>
            <%} else {%>
            <div class="margin-bottom-15 no-padding">
                <h1 class="title-head title_search">Có <%=listProduct.size()%> kết quả tìm kiếm phù hợp cho mức giá ${requestScope.chosenPrice}</h1>
            </div>
            <% } %>
        </div>
                ...
                <div class="price-search-box">
                    <form action="searchPrice" method="post">
                        <div style="display: flex; align-items: center; margin-bottom: 10px; gap: 25px;">
                            <p>Giá tiền: </p>
                            <select name="price-box">
                                <option disabled selected  value="0">Chọn mức giá</option>
                                <option value="4">Trên 1.000.000₫</option>
                                <option value="3">750.000₫ - 1.000.000₫</option>
                                <option value="2">500.000₫ - 750.000₫</option>
                                <option value="1">Dưới 500.000₫</option>
                            </select>
                        </div>
                        <button class="btn btn-primary btn-lg btn-block" style="color: white" type="submit" name="btnDatHang">Tìm kiếm</button>
                    </form> 
                </div>
                                ...
                                <div class="item_product_main">
                                    ...
                                    <div class="variants product-action">
                                        <div class="product-thumbnail">
                                            <a class="image_thumb scale_hover" href="./productDetail?productID=<%=listProduct.get(i).getProductID()%>" style="height: 230px;">
