                ...
                <div class="container mt-4">
                    ...
                    <form class="needs-validation" action="showPayment" method="post">
                        <div class="py-5 text-center">
                            ...
                            <h2>Thanh toán</h2>
                            <p class="lead"> Vui lòng kiểm tra thông tin Khách hàng trước khi Thanh toán. </p>
                        </div>

                        <div class="row">
                            <div class="col-md-4 order-md-2 mb-4">
                                <div class="qr"><img src="images/slide-logo/QR.png" alt="" /></div>
                                <h4
                                ...
                                <ul class="list-group mb-3">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between lh-condensed" >
                                        <div>
                                            <h6 class="my-0"><%=o.getProductID().getProductName()%></h6>
                                            <small class="text-muted"><%=formatter.format(o.getProductID().getUnitPrice() * (100 - o.getProductID().getDiscount()) / 100)%>₫ x <%=o.getQuantity()%></small>
                                        </div>
                                        <span class="text-muted"><%=formatter.format((o.getProductID().getUnitPrice() * (100 - o.getProductID().getDiscount()) / 100) * o.getQuantity())%>₫</span>
                                    </li>
                                    <% } %>
                            ...
                            <div class="col-md-8 order-md-1">
                                ...
                                <div class="d-block my-3">
                                    <div class="custom-control custom-radio">
                                        <input id="httt-2" name="paymentMethod" type="radio" class="custom-control-input" required="" value="bank"/>
                                        <label class="custom-control-label" for="httt-2">Chuyển khoản</label>
                                    </div>
                                    
                                    <div class="custom-control custom-radio">
                                        <input id="httt-3" name="paymentMethod" type="radio" class="custom-control-input" required="" value="cod"/>
                                        <label class="custom-control-label" for="httt-3">Ship COD</label>
                                    </div>
                                </div>
                                <input name="sumPrice" value="<%=sumPrice%>" type="hidden">
                                <button class="btn btn-primary btn-lg btn-block" style="color: white" type="submit" name="btnDatHang">Thanh toán</button>
                            </div>
                        </div>
                    </form>                              
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-5 link-list col-footer">
                        <div class="kk">
                            <a class="l1" href="https://themes.sapo.vn/demo/template-alena"
                               >HNG JEWELRY</a
                            >
